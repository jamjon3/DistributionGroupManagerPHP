    ...
    <body>
        <form name="group_form" method="POST">
            <div ng-controller="distributionGroupCtrl">
                <select id="active_group" name="group" ng-model="selectedGroup" ng-init="selectedGroup = groups[0].value" ng-options="group.value as group.label for group in groups" ng-change="change(selectedGroup)">
